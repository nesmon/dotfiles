...
Item {
    ...
    StackView {
        ...
        readonly property string icon: mediaPlayerPage.iconName || "media-album-cover"
        ...
        Component {
            ...
            Item {
                ...
                PlasmaExtras.PlaceholderMessage {
                    ...
                    text: mediaPlayerPage.playbackStatus > Mpris.PlaybackStatus.Stopped ? i18n("No title") : i18n("No media playing")
                }
            }
        }
    ...
    Loader {
        ...
        active: (!container.hasImage || isLoadingImage)
        asynchronous: true
        sourceComponent: mediaPlayerPage.track ? (isLoadingImage ? busyComponent : fallbackIconItem) : placeholderMessage
    }
}
