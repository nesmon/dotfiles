...
RowLayout {
    ...
    RowLayout {
        ...
        visible: networkPage.availableDevices.wirelessDeviceAvailable || networkPage.availableDevices.modemDeviceAvailable
        ...
        PlasmaComponents3.Switch {
            ...
            readonly property bool administrativelyEnabled:
                ...
                && networkPage.availableDevices.wirelessDeviceAvailable
            ...
            visible: networkPage.availableDevices.wirelessDeviceAvailable
        ...
        PlasmaComponents3.Switch {
            ...
            readonly property bool administrativelyEnabled:
                !PlasmaNM.Configuration.airplaneModeEnabled
                && networkPage.availableDevices.modemDeviceAvailable
            ...
            visible: networkPage.availableDevices.modemDeviceAvailable
        ...
        PlasmaComponents3.Switch {
            ...
            visible: networkPage.availableDevices.modemDeviceAvailable || networkPage.availableDevices.wirelessDeviceAvailable
    ...
    PlasmaComponents3.ToolButton {
        ...
        visible: networkPage.kcmAuthorized
        ...
        onClicked: {
            KCMUtils.KCMLauncher.openSystemSettings(networkPage.kcm)
        }
    }
}
