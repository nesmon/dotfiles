<div style="background-color:#fff3cd; border-left:4px solid:#ff9800; padding:12px; margin:16px 0; border-radius:4px;">
<strong>⚠️ Attention :</strong> Ceci est mon vieux dotfiles. Il est très ancien et risque fortement de ne pas fonctionner du tout sur une configuration moderne.
</div>
